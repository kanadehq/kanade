...
Backlog: v0.14.0 — remove `kanade-agent`'s hardcoded inventory loop; default inventory now ships as a probe yaml. Then Prometheus metrics, 3000-agent simulation, NATS cluster + replicated backend, Postgres migration.
