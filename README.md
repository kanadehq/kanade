...
Backlog: Prometheus metrics, 3000-agent simulation, NATS cluster + replicated backend, Postgres migration, sidebar nav reorganization (Execute / Observe / Manage grouping), surface SPA build into per-PR CI.
