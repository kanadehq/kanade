...
Backlog: Prometheus metrics, 3000-agent simulation, NATS cluster + replicated backend, Postgres migration, Running view (`/activity?tab=running`), sidebar nav reorganization (Execute / Observe / Manage grouping).
