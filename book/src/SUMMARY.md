...
- [Writing scripts for the agent](./developing/writing-agent-scripts.md)
- [Workflow and Contribution](./developing/workflow.md)

# 4. Reference

- [Spec (legacy single-page)](./reference/spec.md)
